...
// const authRoutes = require("./routes/auth"); // Auskommentiert: Google OAuth wird momentan nicht genutzt
...
// Routen
// app.use("/auth", authRoutes); // Auskommentiert: Google OAuth wird momentan nicht genutzt
